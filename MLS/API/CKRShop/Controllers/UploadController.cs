...
namespace CKRShop.Controllers
{
    ...
    public class UploadController : ControllerBase
    {
        ...
        public IActionResult GetImageProduct(string name)
        {
            ...
            Byte[] b = System.IO.File.ReadAllBytes(@$"D:\Flutter\MLS\API\CKRShop\Resources\Images\Products\{c}");
            if (b == null)
            {
                b = null;
            }
        ...
        {
            Byte[] b = System.IO.File.ReadAllBytes(@$"D:\Flutter\MLS\API\CKRShop\Resources\Images\Users\{name}");
            if (b == null)
            {
                b = null;
            }
